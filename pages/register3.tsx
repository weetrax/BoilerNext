        ...
        <div className="my-8">
          <div className="bg-white dark:bg-dark-600 max-w-3xl mx-auto flex flex-col gap-6 items-center border border-gray-300 dark:border-dark-700 py-12">
            ...
            <form
              ...
              className="grid grid-cols-12 gap-4 w-full px-12"
            >
              ...
              <div className="col-span-12">
                <label className="block text-sm font-medium mb-1" htmlFor="tel">
                  {lang.tel.fr}
                </label>
                <InputText
                  type={"tel"}
              ...
              <div className="col-span-12">
                ...
                {password !== passwordConfirm && (
                  <p className="text-red-500">{lang.passwordNotMatch.fr}</p>
                )}
              </div>
